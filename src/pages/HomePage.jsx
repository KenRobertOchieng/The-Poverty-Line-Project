    ...
    <div className='container p-[10px] m-auto'>
      ...
      <div className='container m-auto my-20 '>
        ...
        <div className='grid grid-cols-2 '>
          ...
          {/* section 2 */}
          <div className='text-center m-auto'><h1 data-aos="fade-down" data-aos-delay="100" className='mb-60 text-4xl text-blue-400 font-bold'>Turning Data into Actionable Impact</h1>
